            ...
            <div className="max-w-7xl m-auto">
                <div className='px-6 py-32'>
                    <div>
                        ...
                        <p className="text-2xl ">A family centered multisignature wallet utilizing account abstraction.</p>
                    </div>
                    <div className="flex flex-col items-center lg:flex-row gap-8 mt-16">
                        <div className="h-96 w-[600px] bg-white rounded-xl p-8">
                            <Image 
                                src='/plusIcon.svg'
                                alt='Add Icon'
                                width={60}
                            ...
                            <button className="h-12 w-64 bg-[#1B2C5D] font-semibold rounded-xl text-lg text-white">
                        ...
                        <div className="h-96 w-[600px] bg-white rounded-xl p-8">
                            ...
                            <button className="h-12 w-64 border-[#1B2C5D] border-2 font-semibold rounded-xl text-lg text-[#1B2C5D]">
